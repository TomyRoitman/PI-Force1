...
import cv2
import glob
from camera_calibration_store import load_coefficients, save_stereo_coefficients
import argparse
...
def stereo_calibrate(left_file, right_file, left_dir, left_prefix, right_dir, right_prefix, image_format, save_file, square_size, width=9, height=6):
    ...
    Apply calibration and rectification for stereo cameras operation for images in the given directory path
